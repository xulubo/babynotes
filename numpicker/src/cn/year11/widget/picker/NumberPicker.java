...
package cn.year11.widget.picker;
...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public final NumberPicker.Formatter DEFAULT_FORMATTER = 
    		new NumberPicker.Formatter() {
				
				@Override
				public String toString(int value) {
			        int d = String.valueOf(mEnd).length();
			        mDigitFormat = "%0"+d+"d";
			        return String.format(mDigitFormat, value);	
			    }
			};
    ...
    private Formatter mFormatter = DEFAULT_FORMATTER;
